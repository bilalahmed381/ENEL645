...
![Output Image](images/project_proof.png)
NOTE: Notebooks are used for fine-tuning purpose, after model fine-tuning - dataset, training results and .pt files get zipped into YOLOv5.zip and YOLOv12.zip files respectively.
